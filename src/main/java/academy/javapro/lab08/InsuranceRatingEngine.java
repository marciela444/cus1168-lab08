...
public class InsuranceRatingEngine {
    ...
    private void initializeRules() {
        ...
        rules.add(new Rule("base rate",
            ...
            (profile, premium) -> {
                ...
                if (baseRate == null) {
                    throw new IllegalArgumentException("Base rate not found for vehicle category: " + vehicleCategory);
                }
    ...
    private String determineVehicleCategory(DriverProfile profile) {
        ...
        if (make.equals("bmw") || make.equals("mercedes") || make.equals("lexus") || make.equals("audi")) {
            return "luxury";
        } else if (make.equals("ferrari") || make.equals("porsche") || make.equals("mustang") || make.equals("corvette")) {
            return "sports";
